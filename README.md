...
See the [Text Alternative (ASCII)](#text-alternative-ascii) section below for the compact flow.

### Image-Text Fusion &mdash; the [IMG] placeholder trick

See the [Text Alternative (ASCII)](#text-alternative-ascii) section below for the sequence layout.

### Vision Encoder (SigLIP-inspired)

See the [Text Alternative (ASCII)](#text-alternative-ascii) section below.
